...
For example, 1Password passkeys are exposed through supported browser
extensions; qutebrowser should not add a custom 1Password CLI/API bridge for
WebAuthn signing unless 1Password provides a stable public authenticator
